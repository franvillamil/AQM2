...
% ==========================================================================
\section{Part 1: In-Class (Ordinal, Multinomial, and Count Outcomes)}
% ==========================================================================
...
\begin{enumerate}[label=\alph*)]
  ...
  \item Fit the negative binomial model with the same formula using \code{glm.nb()} from \code{MASS}. In a comment, compare the coefficient on \code{ment} to the Poisson estimate from the Poisson model above. Has it changed substantially? Report the estimated overdispersion parameter \code{theta} from the NB output. Is the overdispersion modest or severe?
...
% ==========================================================================
\section{Part 2: Take-Home (Survival Analysis)}
% ==========================================================================
