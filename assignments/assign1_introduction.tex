...
Create a new R script called \code{problem\_sets/ps1\_plot.R} with the following steps:
...
\begin{itemize}
  ...
  \item It has a \code{problem\_sets/} folder with your R files and a saved plot
...
\section*{Appendix: Setting Up the Command Line on Windows}
...
\section{Using Positron Instead of RStudio}
...
\section{Using Sublime Text 4 as a Code Editor}
