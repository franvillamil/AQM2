...
% ----------------------------------------------------
\begin{frame}
\frametitle{Model fit for rare events: separation plot}
\centering

\includegraphics[width = \textwidth]{../img/separationplot}
  

\begin{itemize}
\item What are we really looking for in a binary model of rare events (e.g. civil wars, genocide, etc)?
\item In R: DIY or \texttt{separationplot} package
\end{itemize}
