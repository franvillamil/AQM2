...
\item Results can change across \textbf{package versions}
  ...
  \item \texttt{renv} (R) or virtual environments (Python) lock versions
  \end{itemize}
\vspace{8pt}
...
\item A well-organized project is already a replication package:
  ...
  \end{itemize}
\vspace{8pt}
\item Example: \href{https://github.com/franvillamil/workflow_example}{\texttt{github.com/franvillamil/workflow\_example}}
\end{itemize}
