...
\begin{forest}
  for tree={
    ...
    s sep=0.2em,          % was 0.2em
    inner sep=1pt,      % reduces padding around node text
    l sep=0.5em,        % tightens parent-child distance too
  }
  [PROJECT\_FOLDER/, text=gray
    [analyses/, text=gray
      [analyze.R]
      [output/, text=gray
        [table\_models.tex]
